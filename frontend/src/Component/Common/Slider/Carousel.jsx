...
const Carousel = () => {
  ...
  return (
    <div className="mt-5 pt-4 pb-5  container-fluid slider">
      <div className="container-xxl">
        <h2 className="heading">Inspiration for your first order</h2>
        <div className="mt-4">
          <Slider {...settings}>
            {topBrandsList.map((brand) => (
              <div className="d-flex gap-4">
                <div className="top-brands-cover flex-shrink-0">
                  <img
